...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 1926, function(sym, e) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${btn_info_for_me_text}", "click", function(sym, e) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${btn_game_info_text}", "click", function(sym, e) {
         sym.play('game');

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${btn_for_project_text}", "click", function(sym, e) {
         sym.play('for_project');

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${btn_back-page}", "click", function(sym, e) {
   ...
   //Edge symbol: 'btn_for_project_text'
   (function(symbolName) {   
   
   })("btn_for_project_text");
   //Edge symbol end:'btn_for_project_text'

   //=========================================================
   
   //Edge symbol: 'btn_game_info_text'
   (function(symbolName) {   
   
   })("btn_game_info_text");
   //Edge symbol end:'btn_game_info_text'

   //=========================================================
   
   //Edge symbol: 'btn_info_for_me_text'
   (function(symbolName) {   
   
   })("btn_info_for_me_text");
   //Edge symbol end:'btn_info_for_me_text'

   //=========================================================
   
   //Edge symbol: 'help_gallery'
   (function(symbolName) {   
