...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${facebook}", "click", function(sym, e) {
         window.open("https://www.facebook.com/martin.marinov.7982", "_blank");

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${facebookCopy}", "click", function(sym, e) {
         window.open("https://www.facebook.com/Angel.Stoyanov.Angelov?ref=br_rs", "_blank");
      ...
      Symbol.bindElementAction(compId, symbolName, "${button12}", "mouseover", function(sym, e) {
         sym.getSymbol("button12").play('on');

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${button12}", "mouseout", function(sym, e) {
         sym.getSymbol("button12").play('out');

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${button2}", "mouseover", function(sym, e) {
         sym.getSymbol("button2").play('on');

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${button2}", "mouseout", function(sym, e) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${button3}", "mouseout", function(sym, e) {
         sym.getSymbol("button3").play('out');
      ...
      Symbol.bindElementAction(compId, symbolName, "${button4}", "mouseout", function(sym, e) {
         sym.getSymbol("button4").play('out');
   ...
   //Edge symbol: 'btn_mail2'
   (function(symbolName) {   
   
      Symbol.bindElementAction(compId, symbolName, "${mail}", "click", function(sym, e) {
         sym.play();
   ...
   //Edge symbol end:'btn_mail2'

   //=========================================================
   
   //Edge symbol: 'btn_skype2'
   (function(symbolName) {   
   
      Symbol.bindElementAction(compId, symbolName, "${skype}", "click", function(sym, e) {
         sym.play();
