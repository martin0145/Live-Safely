...
(function (compId) {
        ...
        symbols = {
                    ...
                    dom: [
                        {
                            ...
                            fill: ["rgba(0,0,0,0)",im+"background-info-author.png",'0px','0px']
                        },
                        {
                            id: 'more_section',
                            type: 'image',
                            rect: ['117px', '115px', '257px', '551px', 'auto', 'auto'],
                            fill: ["rgba(0,0,0,0)",im+"more_section.png",'0px','0px']
                        },
                        {
                            id: 'Text',
                            type: 'text',
                            rect: ['436px', '183px', '462px', '178px', 'auto', 'auto'],
                            text: "<p style=\"margin: 0px; text-align: justify;\">​ &nbsp; &nbsp; Казвам се Мартин Христов Маринов и уча в СУ „Сава Доброплодни“ гр. Шумен. Бъдещите ми планове са свързани с IT индустрията, по-специално с разработването на приложения за мобилни устройства.</p>",
                            align: "center",
                        ...
                        },
                        {
                            id: 'Angel_angelov',
                            type: 'image',
                            rect: ['186px', '443px', '119px', '139px', 'auto', 'auto'],
                            fill: ["rgba(0,0,0,0)",im+"Angelov.png",'0px','0px']
                        },
                        {
                            id: 'btn_skype',
                            symbolName: 'btn_skype',
                            type: 'rect',
                            rect: ['847px', '347px', '51', '50', 'auto', 'auto']
                        },
                        {
                            id: 'btn_skype2',
                            symbolName: 'btn_skype2',
                            type: 'rect',
                            rect: ['847px', '594px', '51', '50', 'auto', 'auto']
                        },
                        {
                            id: 'btn_mailCopy3',
                            symbolName: 'btn_mail',
                            type: 'rect',
                            rect: ['777px', '347px', '51', '50', 'auto', 'auto']
                        },
                        {
                            id: 'btn_mail2',
                            symbolName: 'btn_mail2',
                            type: 'rect',
                            rect: ['777px', '594px', '51', '50', 'auto', 'auto']
                        },
                        {
                            id: 'Rectangle',
                            type: 'rect',
                            rect: ['410px', '413px', '767px', '4px', 'auto', 'auto'],
                        ...
                        },
                        {
                            id: 'RectangleCopy',
                            type: 'rect',
                            rect: ['117px', '413px', '257px', '4px', 'auto', 'auto'],
                            fill: ["rgba(189,195,199,1.00)"],
                            stroke: [0,"rgba(0,0,0,1)","none"]
                        },
                        {
                        ...
                        },
                        {
                            id: 'me3',
                            type: 'image',
                            rect: ['-387px', '-677px', '1265px', '1898px', 'auto', 'auto'],
                            fill: ["rgba(0,0,0,0)",im+"me3.png",'0px','0px'],
                            transform: [[],[],[],['0.0937','0.0937']]
                        },
                        {
                            id: 'facebook',
                            type: 'image',
                            rect: ['707px', '347px', '51px', '50px', 'auto', 'auto'],
                            cursor: 'pointer',
                        ...
                        },
                        {
                            id: 'facebookCopy',
                            type: 'image',
                            rect: ['707px', '594px', '51px', '50px', 'auto', 'auto'],
                            cursor: 'pointer',
                            fill: ["rgba(0,0,0,0)",im+"facebook.png",'0px','0px']
                        },
                        {
                            ...
                            symbolName: 'button1',
                            type: 'rect',
                            rect: ['1144px', '179px', '225', '55', 'auto', 'auto'],
                            cursor: 'pointer'
                        },
                        {
                            id: 'button2',
                            symbolName: 'button2',
                            type: 'rect',
                            rect: ['1144px', '233px', '225', '55', 'auto', 'auto'],
                            cursor: 'pointer'
                        },
                        {
                            id: 'button3',
                            symbolName: 'button3',
                            type: 'rect',
                            rect: ['1144px', '287px', '225', '55', 'auto', 'auto'],
                            overflow: 'visible',
                            cursor: 'pointer'
                        },
                        {
                            ...
                            symbolName: 'button4',
                            type: 'rect',
                            rect: ['1144px', '342', '225', '55', 'auto', 'auto'],
                            overflow: 'visible',
                            cursor: 'pointer'
                        },
                        {
                            ...
                            symbolName: 'button5',
                            type: 'rect',
                            rect: ['1144px', '453px', '225', '55', 'auto', 'auto'],
                            overflow: 'visible',
                            cursor: 'pointer'
                        },
                        {
                            ...
                            symbolName: 'button6',
                            type: 'rect',
                            rect: ['1144px', '508', '225', '55', 'auto', 'auto'],
                            overflow: 'visible',
                            cursor: 'pointer'
                        },
                        {
                            ...
                            symbolName: 'button7',
                            type: 'rect',
                            rect: ['1144px', '563', '225', '55', 'auto', 'auto'],
                            overflow: 'visible',
                            cursor: 'pointer'
                        },
                        {
                            id: 'Rectangle2',
                            type: 'rect',
                            rect: ['1178px', '107px', '190px', '558px', 'auto', 'auto'],
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            id: 'Group',
                            opacity: '0',
                            rect: ['-128px', '-58', '176', '52', 'auto', 'auto'],
                            c: [
                            {
                                rect: ['-20px', '0px', '202px', '50px', 'auto', 'auto'],
                                id: 'info-dialog-game',
                                type: 'image',
                                fill: ['rgba(0,0,0,0)', 'images/info-dialog-game.png', '0px', '0px']
                            },
                            {
                                ...
                                id: 'Text2',
                                textStyle: ['', '', '', '', 'none'],
                                text: '<p style=\"margin: 0px;\">​<span style=\"color: rgb(255, 255, 255); font-size: 21px;\">angelow@dgklaz.net</span></p>',
                                rect: ['-21px', '2px', '202px', '50px', 'auto', 'auto']
                            }]
                        }
                    ],
                    style: {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            id: 'GroupCopy',
                            opacity: '0',
                            rect: ['-128', '-58px', '176', '52', 'auto', 'auto'],
                            c: [
                            {
                                rect: ['0px', '0px', '176px', '50px', 'auto', 'auto'],
                                id: 'info-dialog-gameCopy',
                            ...
                            },
                            {
                                ...
                                align: 'center',
                                id: 'Text2Copy',
                                text: '<p style=\"margin: 0px;\">​<span style=\"color: rgb(255, 255, 255);\">acho_dora</span></p>',
                                textStyle: ['', '', '', '', 'none'],
                                rect: ['0px', '5px', '176px', '36px', 'auto', 'auto']
                            }]
                        }
                    ],
                    style: {
            ...
            "button1": {
                ...
                content: {
                    dom: [
                        {
                            rect: ['0px', '0px', '225px', '55px', 'auto', 'auto'],
                            id: 'image1_for-me',
                            type: 'image',
                            fill: ['rgba(0,0,0,0)', 'images/image1_for-me.png', '0px', '0px']
                        }
                    ],
                    style: {
                        '${symbolSelector}': {
                            overflow: 'visible',
                            rect: [null, null, '225px', '55px']
                        }
                    }
                },
                timeline: {
                    ...
                    dom: [
                        {
                            ...
                            id: 'image2_for-me',
                            rect: ['0px', '0px', '225px', '55px', 'auto', 'auto'],
                            fill: ['rgba(0,0,0,0)', 'images/image2_for-me.png', '0px', '0px']
                        }
                    ],
                    style: {
                        '${symbolSelector}': {
                    ...
                    dom: [
                        {
                            ...
                            id: 'image3_for-me',
                            rect: ['0px', '0px', '225px', '55px', 'auto', 'auto'],
                            fill: ['rgba(0,0,0,0)', 'images/image3_for-me.png', '0px', '0px']
                        }
                    ],
                    style: {
                        '${symbolSelector}': {
                    ...
                    dom: [
                        {
                            ...
                            id: 'image4_for-me',
                            rect: ['0px', '0px', '225px', '55px', 'auto', 'auto'],
                            fill: ['rgba(0,0,0,0)', 'images/image4_for-me.png', '0px', '0px']
                        }
                    ],
                    style: {
                        '${symbolSelector}': {
                    ...
                    dom: [
                        {
                            ...
                            id: 'image5_for-me',
                            type: 'image',
                            fill: ['rgba(0,0,0,0)', 'images/image5_for-me.png', '0px', '0px']
                        }
                    ],
                    style: {
                        '${symbolSelector}': {
                    ...
                    dom: [
                        {
                            ...
                            id: 'image6_for-me',
                            type: 'image',
                            fill: ['rgba(0,0,0,0)', 'images/image6_for-me.png', '0px', '0px']
                        }
                    ],
                    style: {
                        '${symbolSelector}': {
                    ...
                    dom: [
                        {
                            ...
                            id: 'image7_for-me',
                            rect: ['0px', '0px', '225px', '55px', 'auto', 'auto'],
                            fill: ['rgba(0,0,0,0)', 'images/image7_for-me.png', '0px', '0px']
                        }
                    ],
                    style: {
                        '${symbolSelector}': {
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("for-me_edgeActions.js");
})("EDGE-453454929");
