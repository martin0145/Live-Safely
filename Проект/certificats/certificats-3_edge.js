...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            fill: ["rgba(0,0,0,0)",im+"certi-12.png",'0px','0px']
                        },
                        {
                            id: 'btn_online',
                    ...
                    style: {
                        '${Stage}': {
                            isStage: true,
                            rect: ['null', 'null', '1360px', '2070px', 'auto', 'auto'],
                            overflow: 'auto',
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("certificats-3_edgeActions.js");
})("EDGE-453454929");
