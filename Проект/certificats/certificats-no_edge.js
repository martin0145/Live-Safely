...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            id: 'Text',
                            type: 'text',
                            rect: ['284px', '287px', '835px', '149px', 'auto', 'auto'],
                            text: "<p style=\"margin: 0px; text-align: center;\">​<span style=\"color: rgb(52, 73, 94);\">НЯМАШ ОЩЕ СПЕЧЕЛЕНИ СЕРТИФИКАТИ. ПРЕМИНИ НИВО, ЗА ДА ОТКЛЮЧИШ СЕРТИФИКАТ.</span></p>",
                            font: ['Roboto', [40, "px"], "rgba(52,73,94,1.00)", "300", "none", "", "break-word", "normal"]
                        }
                    ],
                    style: {
                        '${Stage}': {
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("certificats-no_edgeActions.js");
})("EDGE-453454929");
