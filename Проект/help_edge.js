...
(function (compId) {
        ...
        symbols = {
                    ...
                    dom: [
                        {
                            ...
                            symbolName: 'third2',
                            type: 'rect',
                            rect: ['-418px', '1780px', '59', '91', 'auto', 'auto']
                        },
                        {
                            id: 'second2',
                            symbolName: 'second2',
                            type: 'rect',
                            rect: ['-160px', '1666px', '59', '91', 'auto', 'auto']
                        },
                        {
                            id: 'first2',
                            symbolName: 'first2',
                            type: 'rect',
                            rect: ['-418px', '1588px', '59', '91', 'auto', 'auto']
                        },
                        {
                            id: 'fourth2',
                            symbolName: 'fourth2',
                            type: 'rect',
                            rect: ['-151px', '1946px', '59', '91', 'auto', 'auto']
                        },
                        {
                            id: 'background-info-help',
                            type: 'image',
                            rect: ['410px', '115px', '767px', '550px', 'auto', 'auto'],
                            fill: ["rgba(0,0,0,0)",im+"background-info-help.png",'0px','0px']
                        },
                        {
                            id: 'Text3',
                            type: 'text',
                            rect: ['410px', '122px', '767px', '38px', 'auto', 'auto'],
                            text: "<p style=\"margin: 0px;\">​Информация</p>",
                            align: "center",
                            font: ['Roboto', [22, "px"], "rgba(255,255,255,1.00)", "700", "none", "normal", "break-word", "normal"],
                            textStyle: ["", "", "", "", "none"]
                        },
                        {
                            id: 'background-help',
                            ...
                            fill: ["rgba(0,0,0,0)",im+"background-help.png",'0px','0px']
                        },
                        {
                            id: 'btn_logo2',
                        ...
                        },
                        {
                            id: 'more_section2',
                            type: 'image',
                            rect: ['117px', '114px', '257px', '551px', 'auto', 'auto'],
                            fill: ["rgba(0,0,0,0)",im+"more_section.png",'0px','0px']
                        },
                        {
                            id: 'help_gallery',
                            symbolName: 'help_gallery',
                            type: 'rect',
                            rect: ['117', '114', '257', '551', 'auto', 'auto']
                        },
                        {
                            id: 'categories-help2',
                            type: 'image',
                            rect: ['117px', '115px', '257px', '177px', 'auto', 'auto'],
                            fill: ["rgba(0,0,0,0)",im+"categories-help2.png",'0px','0px']
                        },
                        {
                            id: 'for_project',
                            type: 'text',
                            rect: ['437px', '213px', '682px', '277px', 'auto', 'auto'],
                            opacity: '0',
                            text: "<p style=\"margin: 0px; text-align: justify;\"><span style=\"font-weight: 200;\">&nbsp; „Живей безопасно“ е проект, който цели да покаже на децата, че безопасността е от голямо значение за нас и че трябва да се пазим, за да бъдем живи и здрави. Под формата на игра с въпроси (куест), детето (ученикът) научава как да реагира в трудни ситуации и научава как да се справи с &nbsp;последиците.</span></p><p style=\"margin: 0px; text-align: justify;\"><span style=\"font-weight: 200;\">​</span></p><p style=\"margin: 0px; text-align: justify;\"><span style=\"font-weight: 200;\">&nbsp; Чрез приложението се предоставя възможност на потребителите, както да придобият нови знания за безопасността, така и да ги затвърдят чрез интерактивни анимации.</span></p><p style=\"margin:0px\"><span style=\"font-weight: 200;\">​</span></p>",
                            align: "justify",
                            font: ['Roboto', [22, "px"], "rgba(54,74,95,1.00)", "400", "none", "normal", "break-word", "normal"],
                            textStyle: ["", "", "", "", "none"]
                        },
                        {
                            id: 'text',
                            type: 'text',
                            rect: ['869px', '550px', '272px', '38px', 'auto', 'auto'],
                            opacity: '0',
                            text: "<p style=\"margin: 0px; text-align: justify;\"><span style=\"font-weight: 300;\">&nbsp; Изтегли проекта от &nbsp; &nbsp; &nbsp; .</span></p>",
                            align: "justify",
                            font: ['Roboto', [22, "px"], "rgba(54,74,95,1.00)", "400", "none", "normal", "break-word", "normal"],
                            textStyle: ["", "", "", "", "none"]
                        },
                        {
                            id: 'download_button',
                            symbolName: 'download_button',
                            type: 'rect',
                            rect: ['1083px', '550px', '40', '31', 'auto', 'auto'],
                            cursor: 'pointer'
                        },
                        {
                            id: 'game_text',
                            ...
                            rect: ['437px', '213px', '682px', '277px', 'auto', 'auto'],
                            opacity: '0',
                            text: "<p style=\"margin: 0px; text-align: justify;\">&nbsp; При стартирането на играта се показва околната среда или къде ще се развиват ситуациите. Играта се състои от 4 въпроса и всеки въпрос има по 3 възможни отговора. При посочване на един от отговорите може да се види дли е правилен. Отговорите на всеки въпрос са представени под формата на картинка и бутон за пояснение. Над въпросите има лента, която показва на потребителя докъде е стигнал.</p><p style=\"margin: 0px; text-align: justify;\">​</p><p style=\"margin: 0px; text-align: justify;\">&nbsp; Целта на играта е децата да опознаят опасните ситуации и да се научат да реагират адекватно. Потребителят да възприема бедствието чрез различни сетива. Да развива своята бдителност и внимание, спазва указания и инструкции и др.</p>",
                            align: "justify",
                        ...
                        },
                        {
                            ...
                            rect: ['437px', '213px', '682px', '277px', 'auto', 'auto'],
                            opacity: '0',
                            text: "<p style=\"margin: 0px; text-align: justify;\">&nbsp;Секцията \"За мен\" съдържа информация за човека, който е разработил проекта. Оттам потребителят може да се свърже с мен чрез Skype, E-mail или Facebook, за да предложи нови идеи, свързани с проекта, препоръки или да споделим мнение. Това е път за усъвършенстване и надграждане на проекта.</p>",
                            align: "justify",
                            font: ['Roboto', [22, "px"], "rgba(54,74,95,1.00)", "200", "none", "normal", "break-word", "normal"],
                            textStyle: ["", "", "", "", "none"]
                        },
                        {
                            id: 'Text3Copy',
                            type: 'text',
                            rect: ['112px', '123px', '257px', '38px', 'auto', 'auto'],
                            text: "<p style=\"margin: 0px;\">​Категории</p>",
                            align: "center",
                            font: ['Roboto', [22, "px"], "rgba(255,255,255,1.00)", "700", "none", "normal", "break-word", "normal"],
                            textStyle: ["", "", "", "", "none"]
                        },
                        {
                            id: 'btn_for_project_text',
                            symbolName: 'btn_for_project_text',
                            type: 'rect',
                            rect: ['112', '164', '257', '38', 'auto', 'auto']
                        },
                        {
                            id: 'btn_game_info_text',
                            symbolName: 'btn_game_info_text',
                            type: 'rect',
                            rect: ['112', '204', '257', '38', 'auto', 'auto']
                        },
                        {
                            id: 'btn_info_for_me_text',
                            symbolName: 'btn_info_for_me_text',
                            type: 'rect',
                            rect: ['112', '245', '257', '38', 'auto', 'auto']
                        }
                    ],
                    style: {
                        '${Stage}': {
                            isStage: true,
                            rect: ['null', 'null', '1360px', '768px', 'auto', 'auto'],
                            overflow: 'auto',
                    ...
                    dom: [
                        {
                            ...
                            id: 'logo22',
                            type: 'image',
                            fill: ['rgba(0,0,0,0)', 'images/logo22.png', '0px', '0px']
                        }
                    ],
                    style: {
                        '${symbolSelector}': {
            ...
            "btn_for_project_text": {
                ...
                content: {
                    dom: [
                        {
                            font: ['Roboto', [22, 'px'], 'rgba(54,74,95,1.00)', '600', 'none', 'normal', 'break-word', 'normal'],
                            type: 'text',
                            align: 'center',
                            id: 'TextCopy2',
                            text: '<p style=\"margin: 0px; text-align: center;\">​За проекта</p>',
                            textStyle: ['', '', '', '', 'none'],
                            rect: ['0px', '0px', '257px', '38px', 'auto', 'auto']
                        },
                        {
                            transform: [[], [], [], ['0.90175', '0.49066']],
                            id: 'hotspot',
                            symbolName: 'hotspot',
                            rect: ['-8px', '-30px', '285', '70', 'auto', 'auto'],
                            type: 'rect'
                        }
                    ],
                    style: {
                        '${symbolSelector}': {
                            rect: [null, null, '257px', '38px']
                        }
                    }
                },
                timeline: {
                    ...
                    dom: [
                        {
                            ...
                            align: 'center',
                            id: 'TextCopy3',
                            text: '<p style=\"margin: 0px; text-align: center;\">​Играта</p>',
                            textStyle: ['', '', '', '', 'none'],
                            rect: ['0px', '0px', '257px', '38px', 'auto', 'auto']
                        },
                        {
                            ...
                            id: 'hotspotCopy',
                            symbolName: 'hotspot',
                            rect: ['-13px', '-21px', '285', '70', 'auto', 'auto'],
                            type: 'rect'
                        }
                    ],
                    style: {
                    ...
                    dom: [
                        {
                            ...
                            align: 'center',
                            id: 'TextCopy4',
                            text: '<p style=\"margin: 0px; text-align: center;\">​За мен</p>',
                            textStyle: ['', '', '', '', 'none'],
                            rect: ['0px', '0px', '257px', '38px', 'auto', 'auto']
                        },
                        {
                            ...
                            id: 'hotspotCopy2',
                            symbolName: 'hotspot',
                            rect: ['-13px', '-16px', '285', '70', 'auto', 'auto'],
                            type: 'rect'
                        }
                    ],
                    style: {
            ...
            "help_gallery": {
                ...
                content: {
                    dom: [
                        {
                            rect: ['0px', '177px', '257px', '329px', 'auto', 'auto'],
                            id: 'image3_gallery4',
                            opacity: '1',
                            type: 'image',
                            fill: ['rgba(0,0,0,0)', 'images/image3_gallery_help.png', '0px', '0px']
                        },
                        {
                            rect: ['0px', '177px', '257px', '329px', 'auto', 'auto'],
                            id: 'image2_gallery4',
                            opacity: '1',
                            type: 'image',
                            fill: ['rgba(0,0,0,0)', 'images/image2_gallery_help.png', '0px', '0px']
                        },
                        {
                            rect: ['0px', '177px', '257px', '329px', 'auto', 'auto'],
                            id: 'image1_gallery5',
                            opacity: '1',
                            type: 'image',
                            fill: ['rgba(0,0,0,0)', 'images/image1_gallery_help.png', '0px', '0px']
                        },
                        {
                            rect: ['152px', '519px', '13px', '13px', 'auto', 'auto'],
                            borderRadius: ['50%', '50%', '50%', '50%'],
                            type: 'ellipse',
                            id: 'EllipseCopy2',
                            stroke: [0, 'rgba(0,0,0,1)', 'none'],
                            cursor: 'pointer',
                            fill: ['rgba(79,193,233,1.00)']
                        },
                        {
                            rect: ['122px', '519px', '13px', '13px', 'auto', 'auto'],
                            borderRadius: ['50%', '50%', '50%', '50%'],
                            type: 'ellipse',
                            id: 'EllipseCopy',
                            stroke: [0, 'rgba(0,0,0,1)', 'none'],
                        ...
                        {
                            rect: ['92px', '519px', '13px', '13px', 'auto', 'auto'],
                            borderRadius: ['50%', '50%', '50%', '50%'],
                            type: 'ellipse',
                            id: 'Ellipse',
                            stroke: [0, 'rgba(0,0,0,1)', 'none'],
                            cursor: 'pointer',
                            fill: ['rgba(42,135,168,1.00)']
                        }
                    ],
                    style: {
                        '${symbolSelector}': {
                            rect: [null, null, '257px', '551px']
                        }
                    }
                },
                timeline: {
            ...
            "button_download": {
                ...
                content: {
                    dom: [
                        {
                            font: ['Roboto', [22, 'px'], 'rgba(54,74,95,1)', '400', 'none', 'normal', 'break-word', 'normal'],
                            type: 'text',
                            align: 'justify',
                            id: 'Text',
                            textStyle: ['', '', '', '', 'none'],
                            text: '<p style=\"margin: 0px;\">​тук</p>',
                            rect: ['9px', '2px', '59px', '38px', 'auto', 'auto']
                        },
                        {
                            type: 'rect',
                            id: 'Rectangle',
                            stroke: [0, 'rgba(0,0,0,1)', 'none'],
                            rect: ['0px', '0px', '59px', '38px', 'auto', 'auto'],
                            fill: ['rgba(192,192,192,0.00)']
                        }
                    ],
                    style: {
                        '${symbolSelector}': {
                            rect: [null, null, '59px', '38px']
                        }
                    }
                },
                timeline: {
                    ...
                    dom: [
                        {
                            ...
                            textStyle: ['', '', '', '', 'none'],
                            text: '<p style=\"margin: 0px;\">​тук</p>',
                            rect: ['0px', '0px', '40px', '31px', 'auto', 'auto']
                        }
                    ],
                    style: {
                        '${symbolSelector}': {
                            rect: [null, null, '40px', '31px']
                        }
                    }
                },
                timeline: {
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("help_edgeActions.js");
})("EDGE-453454929");
