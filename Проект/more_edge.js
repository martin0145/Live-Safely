...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            text: "<p style=\"margin: 0px;\">​Полезни връзки</p>",
                            align: "center",
                        ...
                        },
                        {
                            id: 'for_project',
                            type: 'text',
                            rect: ['437px', '213px', '258px', '29px', 'auto', 'auto'],
                            overflow: 'hidden',
                            cursor: 'pointer',
                            opacity: '1',
                            text: "<p style=\"margin: 0px;\">Български Червен кръст</p>",
                            align: "justify",
                            font: ['Roboto', [22, "px"], "rgba(54,74,95,1.00)", "300", "none", "normal", "break-word", "normal"],
                            textStyle: ["", "", "", "", "none"]
                        },
                        {
                            id: 'for_projectCopy',
                            type: 'text',
                            rect: ['437px', '263px', '321px', '29px', 'auto', 'auto'],
                            overflow: 'hidden',
                            cursor: 'pointer',
                            opacity: '1',
                            text: "<p style=\"margin: 0px;\">​Планинска спасителна служба</p>",
                            align: "justify",
                            font: ['Roboto', [22, "px"], "rgba(54,74,95,1.00)", "300", "none", "normal", "break-word", "normal"],
                            textStyle: ["", "", "", "", "none"]
                        },
                        {
                            id: 'for_projectCopy2',
                            type: 'text',
                            rect: ['437px', '313px', '283px', '29px', 'auto', 'auto'],
                            overflow: 'hidden',
                            cursor: 'pointer',
                            opacity: '1',
                            text: "<p style=\"margin: 0px;\">​МВР /&nbsp;Спасителна система</p>",
                            align: "justify",
                            font: ['Roboto', [22, "px"], "rgba(54,74,95,1.00)", "300", "none", "normal", "break-word", "normal"],
                            textStyle: ["", "", "", "", "none"]
                        },
                        {
                            id: 'for_projectCopy3',
                            type: 'text',
                            rect: ['437px', '363px', '414px', '29px', 'auto', 'auto'],
                            overflow: 'hidden',
                            cursor: 'pointer',
                            opacity: '1',
                            text: "<p style=\"margin: 0px;\">​МВР / Наръчник за детска безопасност</p>",
                            align: "justify",
                            font: ['Roboto', [22, "px"], "rgba(54,74,95,1.00)", "300", "none", "normal", "break-word", "normal"],
                            textStyle: ["", "", "", "", "none"]
                        },
                        {
                            id: 'for_projectCopy4',
                            type: 'text',
                            rect: ['437px', '413px', '345px', '50px', 'auto', 'auto'],
                            overflow: 'hidden',
                            cursor: 'pointer',
                            opacity: '1',
                            text: "<p style=\"margin: 0px;\">МВР Шумен / Пътна безопасност</p>",
                            align: "justify",
                            font: ['Roboto', [22, "px"], "rgba(54,74,95,1.00)", "300", "none", "normal", "break-word", "normal"],
                            textStyle: ["", "", "", "", "none"]
                        },
                        {
                            id: 'more_section',
                            type: 'image',
                            rect: ['103px', '114px', '257px', '551px', 'auto', 'auto'],
                            fill: ["rgba(0,0,0,0)",im+"more_section.png",'0px','0px']
                        },
                        {
                            id: 'gallery_animation',
                            symbolName: 'gallery_animation',
                            type: 'rect',
                            rect: ['203', '621', '73', '13', 'auto', 'auto']
                        }
                    ],
                    style: {
                        '${Stage}': {
                    ...
                    dom: [
                        {
                            ...
                            textStyle: ['', '', '', '', 'none'],
                            font: ['Roboto', [22, 'px'], 'rgba(123,123,123,1.00)', '500', 'none', 'normal', 'break-word', 'normal']
                        },
                        {
                    ...
                    dom: [
                        {
                            font: ['Roboto', [22, 'px'], 'rgba(123,123,123,1.00)', '500', 'none', 'normal', 'break-word', 'normal'],
                            type: 'text',
                            text: '<p style=\"margin: 0px; text-align: center;\">​Полезни връзки</p>',
                            id: 'Text',
                            textStyle: ['', '', '', '', 'none'],
                            align: 'center',
                            rect: ['0px', '0px', '256px', '29px', 'auto', 'auto']
                        },
                        {
                            rect: ['0px', '-7px', '256px', '39px', 'auto', 'auto'],
                            type: 'rect',
                            id: 'Rectangle',
                            stroke: [0, 'rgba(0,0,0,1)', 'none'],
                            cursor: 'pointer',
            ...
            "gallery_animation": {
                ...
                content: {
                    dom: [
                        {
                            type: 'image',
                            id: 'image1_gallery5Copy',
                            opacity: '1',
                            rect: ['-100px', '-506px', '257px', '507px', 'auto', 'auto'],
                            fill: ['rgba(0,0,0,0)', 'images/image1_gallery5.png', '0px', '0px']
                        },
                        {
                            type: 'image',
                            id: 'image3_gallery4',
                            opacity: '1',
                            rect: ['-100px', '-506px', '257px', '507px', 'auto', 'auto'],
                            fill: ['rgba(0,0,0,0)', 'images/image3_gallery4.png', '0px', '0px']
                        },
                        {
                            type: 'image',
                            id: 'image2_gallery4',
                            opacity: '1',
                            rect: ['-100px', '-506px', '257px', '507px', 'auto', 'auto'],
                            fill: ['rgba(0,0,0,0)', 'images/image2_gallery4.png', '0px', '0px']
                        },
                        {
                            type: 'image',
                            id: 'image1_gallery5',
                        ...
                        },
                        {
                            type: 'ellipse',
                            borderRadius: ['50%', '50%', '50%', '50%'],
                            rect: ['52px', '13px', '13px', '13px', 'auto', 'auto'],
                            id: 'EllipseCopy2',
                            stroke: [0, 'rgba(0,0,0,1)', 'none'],
                            cursor: 'pointer',
                        ...
                        },
                        {
                            type: 'ellipse',
                            borderRadius: ['50%', '50%', '50%', '50%'],
                            rect: ['22px', '13px', '13px', '13px', 'auto', 'auto'],
                            id: 'Ellipse',
                            stroke: [0, 'rgba(0,0,0,1)', 'none'],
                            cursor: 'pointer',
                            fill: ['rgba(79,193,233,1.00)']
                        },
                        {
                            type: 'ellipse',
                            borderRadius: ['50%', '50%', '50%', '50%'],
                            rect: ['-8px', '13px', '13px', '13px', 'auto', 'auto'],
                            id: 'EllipseCopy',
                            stroke: [0, 'rgba(0,0,0,1)', 'none'],
                            cursor: 'pointer',
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("more_edgeActions.js");
})("EDGE-453454929");
